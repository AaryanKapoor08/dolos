-- Phase 3D: Flowable BPMN process-engine schema. House rule: Flyway owns every table
-- (Hibernate ddl-auto=none; Flowable database-schema-update=false). The process engine's IDM and
-- event-registry sub-engines are disabled in application.yml, so only the process-engine tables are
-- needed here.
--
-- This file is the VERBATIM concatenation, in Flowable's own creation order, of the bundled
-- PostgreSQL create scripts from the flowable-*:7.1.0 jars:
--   1. flowable-engine-common : org/flowable/common/db/create/flowable.postgres.create.common.sql
--   2. flowable-engine        : org/flowable/db/create/flowable.postgres.create.engine.sql
--   3. flowable-engine        : org/flowable/db/create/flowable.postgres.create.history.sql
--
-- The ACT_GE_PROPERTY *.schema.version rows (7.1.0.2) MUST match the library: with
-- database-schema-update=false, Flowable validates them on boot. Do not hand-edit; regenerate from
-- the matching Flowable jars if the version is bumped.

-- ============================================================================================
-- 1/3  flowable.postgres.create.common.sql  (flowable-engine-common 7.1.0)
-- ============================================================================================
...
-- ============================================================================================
-- 2/3  flowable.postgres.create.engine.sql  (flowable-engine 7.1.0)
-- ============================================================================================
...
-- ============================================================================================
-- 3/3  flowable.postgres.create.history.sql  (flowable-engine 7.1.0)
-- ============================================================================================
